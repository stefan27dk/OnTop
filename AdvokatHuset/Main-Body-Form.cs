...
namespace View_GUI
{
    ...
    public partial class Main_Body_Form : Form
    {
        ...
        private void LoadExternalApplication()
        {
            CenterToScreen();
            if (externalAppPath != "")
            {
                  ProcessStartInfo info = new ProcessStartInfo();
                  info.FileName = externalAppPath;
        ...
        // Resize External App with main window
        private void Main_Body_Form_Resize(object sender, EventArgs e)
        {
            if (externalAppPath != "")
            {
                MoveWindow(p.MainWindowHandle, 0, 0, this.Width, this.Height, true);
        ...
        private void Main_Body_Loader_panel_DragDrop(object sender, DragEventArgs e)
        {
        ...
        // On Enter Drag
        private void Main_Body_Loader_panel_DragEnter(object sender, DragEventArgs e)
        {
